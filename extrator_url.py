...
class ExtratorUrl:
    ...
    def valida_url(self):
        ...
        if not match:
            raise ValueError("A URL não é valída...")
    ...
    def get_valor_parametro(self, parametro_busca):
        ...
        indice_e_comercial = self.get_url_parametros().find("&", indice_valor) # caso não encontrado retorna -1
...
print(extrator_url)
print("o tamanho da url é", len(extrator_url), "caracteres", sep=" ")
